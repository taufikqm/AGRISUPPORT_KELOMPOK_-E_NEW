                        ...
                        {areas && areas.length > 0 && (
                            <div className="relative">
                                ...
                                <select
                                    ...
                                    className="pl-9 pr-8 py-2.5 text-[13px] font-bold text-slate-700 bg-white border border-slate-200 rounded-xl shadow-sm appearance-none cursor-pointer hover:border-[#3D5A3D]/40 focus:outline-none focus:ring-2 focus:ring-[#3D5A3D]/20 focus:border-[#3D5A3D] transition-all"
                                >
                                    <option value="">Semua Lahan (Terbaru)</option>
                                    {areas.map(area => (
